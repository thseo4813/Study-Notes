...
```
┌─────────────────────────────────────────────────────────────────┐
│ L7 Application │ 사용자와 직접 상호작용                         │
├─────────────────────────────────────────────────────────────────┤
│ L6 Presentation│ 데이터 형식 변환 (암호화, 압축)                │
├─────────────────────────────────────────────────────────────────┤
│ L5 Session     │ 연결 세션 관리                                 │
├─────────────────────────────────────────────────────────────────┤
│ L4 Transport   │ 종단 간 신뢰성 (TCP/UDP)                       │
├─────────────────────────────────────────────────────────────────┤
│ L3 Network     │ 논리적 주소 지정, 라우팅 (IP)                  │
├─────────────────────────────────────────────────────────────────┤
│ L2 Data Link   │ 물리적 주소 지정, 프레이밍 (MAC)               │
├─────────────────────────────────────────────────────────────────┤
│ L1 Physical    │ 비트를 전기/광 신호로 변환                     │
└─────────────────────────────────────────────────────────────────┘
```
